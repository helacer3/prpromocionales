...
$path = "index.php?option=com_catpromocional&view=catproveedor&layout=edit&id=";
$pathPublic = "index.php?option=com_catpromocional&task=catproveedor.chInfo&id=";
?>
