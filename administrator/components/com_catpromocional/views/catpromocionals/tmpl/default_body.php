...
$path = "index.php?option=com_catpromocional&view=catpromocional&layout=edit&id=";
$pathPublic = "index.php?option=com_catpromocional&task=catPromocionals.chInfo&id=";
?>
<?php foreach($this->items as $i => $item): ?>
	<tr class="<?php if($i % 2 == 0) echo "PRregisters_reporte"; else echo "PRregisters_reporteB";?> row<?php echo $i % 2; ?>">
		...
		<td>
                        <?php $item->publicado == 1? $pb=0: $pb=1; ?>
                        <a href="<?php echo $pathPublic.$item->id."&tp=2&pb=".$pb; ?>">
                        <?php 
                        if ($item->publicado == 1)
