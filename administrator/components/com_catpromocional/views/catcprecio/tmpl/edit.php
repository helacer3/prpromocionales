    ...
    <div class="form-horizontal">
        <fieldset class="adminform">
            <legend class="PRtitle">
                <?php echo JText::_('COM_CATPROMOCIONAL_CATPROMOCIONAL_CPRECIOS'); ?>
                <a href="<?php echo JURI::base() ."../media/com_catpromocional/files/ejemplos/preciosPrpromocionales.xlsx"; ?>">Ver archivo ejemplo</a>
            </legend>
            <div class="row-fluid">
                <div class="span6">
