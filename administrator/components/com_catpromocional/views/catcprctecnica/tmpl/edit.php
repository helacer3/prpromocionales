    ...
    <div class="form-horizontal">
        <fieldset class="adminform">
            <legend class="PRtitle">
                <?php echo JText::_('COM_CATPROMOCIONAL_CATPROMOCIONAL_CCATPRECIOS'); ?>
                <a href="<?php echo JURI::base() ."../media/com_catpromocional/files/ejemplos/modelostslPrpromocionales.xlsx"; ?>">Ver archivo ejemplo</a>
            </legend>
            <div class="row-fluid">
                <div class="span6">
