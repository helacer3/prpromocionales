...
$path = "index.php?option=com_catpromocional&view=catcosto&layout=edit&id=";
$pathPublic = "index.php?option=com_catpromocional&task=catcosto.chInfo&id=";
?>
