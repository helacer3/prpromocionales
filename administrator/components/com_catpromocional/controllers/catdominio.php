 ...
 */
class CatPromocionalControllerCatDominio extends JControllerForm
{
    /*
    ...
    public function chInfo() {
        ...
        //echo $id."-".$pb;exit;   
        // Obtengo el model.
        $model = $this->getModel('catdominio'); 
        $model->setValue($id,$pb);         
        // Redirecciona a vista inicial.
        $app->redirect(JRoute::_('index.php?option=com_catpromocional&view=catdominio', false));
    }
}