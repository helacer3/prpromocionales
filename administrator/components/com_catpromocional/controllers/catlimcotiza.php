 ...
 */
class CatPromocionalControllerCatLimcotiza extends JControllerForm
{
    /*
    ...
    public function chInfo() {
        ...
        //echo $id."-".$pb;exit;   
        // Obtengo el model.
        $model = $this->getModel('catlimcotiza'); 
        $model->setValue($id,$pb);         
        // Redirecciona a vista inicial.
        $app->redirect(JRoute::_('index.php?option=com_catpromocional&view=catlimcotiza', false));
    }
    public function postSaveHook($model, $validData)
    {
        // Obtengo el model.
        //$model = $this->getModel('catlimcotiza'); 
        $model->setQuotationsByUser($model);
    }
}