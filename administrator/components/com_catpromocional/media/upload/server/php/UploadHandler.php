...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $pathImages = "/../../../../../../../images/catalog/products/";
        /*echo "<br />aca1 ".$this->get_full_url();
        echo "<br />aca2 ".dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/';
        echo "<br />aca2 ".dirname($this->get_server_var('SCRIPT_FILENAME')).$pathImages;
        exit;*/
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            //'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
            //'upload_url' => $this->get_full_url().'/files/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).$pathImages,
            'upload_url' => $this->get_full_url().$pathImages,
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
