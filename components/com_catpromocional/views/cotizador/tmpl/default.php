...
<div id="tabs">
    <ul id="tabsID">
      ...
      <li><a class="tituloTab" href="#tabs-1">ESPECIFICACIONES</a></li>
    </ul>
    <div id="tabs-1">
        <p>
        <?php 
            echo 
            CatpromocionalModelGenerals::getFormatString($this->infproduct->descripcion)
            ."<br /><br />".
            CatpromocionalModelGenerals::getFormatString($this->infproduct->especificaciones);
        ?>
        </p> 
    </div>
    <!--<div id="tabs-2">
