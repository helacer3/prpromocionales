...
$scriptJS = "
function onSubmitRegisterInternal() {
    var username = jQuery('#jform_email1').val();        
    var password = jQuery('#jform_password1').val();    
    var telefono = jQuery('#jform_profile_phone2').val();
    var ciudad   = jQuery('#jform_profile_city').val();
    var pais     = jQuery('#jform_profile_country').val();
    var empresa  = jQuery('#jform_profile_company').val();
    ...
    if (
        ...
        alert('Favor diligencia toda la información marcada con *, para poder continuar con el registro');
        grecaptcha.reset();
    } else if(telefono == '' || telefono.length < 7) {
        alert('Debe digitar su número de teléfono celular, para poder realizar la cotización');
        grecaptcha.reset();
    } else {
        // evento Analytics - Registro Formulario Express
...
jQuery( document ).ready(function() {
    // on change Password
    jQuery('.fieldpasswordB').on('change', function() { 
        jQuery('.fieldpasswordB2').val(jQuery(this).val());
    });
    // on change Email
    jQuery('.fieldemailB').on('change', function() {
        jQuery('.fieldemailB2').val(jQuery(this).val());
    });
            ...
            <table class="table" >
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="email" name="jform[email1]" id="jform_email1" class="InfoUser fieldemailB" required >
                            <input type="hidden" name="jform[email2]" id="jform_email2" class="InfoUser fieldemailB2" required >
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" name="jform[password1]" id="jform_password1" class="InfoUser fieldpasswordB" required >
                            <input type="hidden" name="jform[password2]" id="jform_password2" class="InfoUser fieldpasswordB2" required >
                        </td>
                    </tr>
                    <!--<tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td id="tdregistrar" colspan="2">
                            ...
                            id="registrar"
                            class="g-recaptcha"
                            data-sitekey="6LdublYUAAAAAB_JhUSAeAElYRB2jnLsNXkkX-1L"
                            data-callback='onSubmitRegisterInternal'>
                            Registrarme
                            </button>
                        </td>
                    </tr>
