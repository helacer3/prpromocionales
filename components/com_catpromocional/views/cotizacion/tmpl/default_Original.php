...
table.interna td.imagen, table.interna th.imagen {
...
<table class="principal">
                ...
                if (count($this->itemquotation) > 0) {
                    foreach ($this->itemquotation as $item) {                        
                        ...
                        <tr>
                            ...
                            <td class="imagen" align="center" style="background-color: #FFF; text-align: center;">
                                <?php
                                // get Image Size.
    ...
    ?>
        ...
        <tr>
            <td colspan="4" class="box-title-executive">
                <h3><i class="fa fa-adjust"></i>Empresa</h3>
            </td>
        </tr>
        <tr>
            <td colspan="4" id="notes_executive">
        ...
        <tr>
            <td colspan="4" class="box-title-executive">
                <h3><i class="fa fa-bolt"></i>Ciudad</h3>
            </td>
        </tr>
        <tr>
            <td colspan="4" id="notes_executive">
        ...
        <tr>
            <td colspan="4" class="box-title-executive">
                <h3><i class="fa fa-bolt"></i>Tel&eacute;fono</h3>
            </td>
        </tr>
        <tr>
            <td colspan="4" id="notes_executive">
